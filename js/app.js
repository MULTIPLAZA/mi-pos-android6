...
function _filterPInternal(){
  ...
  // Botón de Reservas/Calendario en la barra: solo visible en la categoría Habitaciones
  const _btnHabCal = document.getElementById('btnHabResCal');
  if(_btnHabCal) _btnHabCal.style.display = (curCat==='Habitaciones') ? '' : 'none';
