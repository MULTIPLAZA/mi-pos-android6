  ...
  ov.innerHTML =
    '<div style="background:var(--card);border:1px solid var(--border);border-radius:14px;max-width:520px;width:100%;padding:24px;color:var(--text);max-height:90vh;overflow-y:auto">'+
      ...
      '<div style="display:flex;gap:10px;margin-bottom:14px;flex-wrap:wrap">'+
        '<a href="/downloads/usb-print-server-windows.zip" download target="_blank" rel="noopener" style="flex:1;min-width:180px;background:var(--green);border:none;border-radius:8px;color:#fff;font:800 14px Barlow,sans-serif;padding:13px;text-align:center;text-decoration:none">\u2b07 Descargar usb-print-server-windows.zip</a>'+
...
var BTPrinter = {
  ...
  buildCierreTurno(data, cols) {
    ...
    // Conteo
    if (data.totalContado > 0) {
      txt += '[BOLD]CONTEO DEL CAJERO[/BOLD]' + n;
      txt += sep2 + n;
      // Arqueo multi-moneda
